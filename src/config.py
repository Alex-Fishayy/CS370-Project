...
MAX_FACES = 10               # MediaPipe Face Mesh cap
...
PHONE_DETECT_EVERY_N_FRAMES = 2  # run phone detection every N processed frames
...
ATTENTION_ANALYSIS_EVERY_N_FRAMES = 30  # run full attention analysis every N display frames
